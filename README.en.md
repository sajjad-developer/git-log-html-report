...
[![Bundle Size (min+gzip)](https://img.shields.io/bundlephobia/minzip/git-log-html-report?label=bundle%20size "Minified + gzip bundle size")](https://bundlephobia.com/result?p=git-log-html-report)
